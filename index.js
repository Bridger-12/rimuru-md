    ...
    ALYA.ev.on('group-participants.update', async (anu) => {
        ...
        try {
            ...
            for (let num of participants) {
                ...
                if (anu.action == 'add') {
                    ALYA.sendMessage(anu.id, { image: { url: ppuser }, mentions: [num], caption: `@${num.split("@")[0]} Welcome To ${metadata.subject} Jangan Lupa Baca Deskripsi @${num.split("@") [ 0 ]}` })
                } else if (anu.action == 'remove') {
                    ALYA.sendMessage(anu.id, { image: { url: ppuser }, mentions: [num], caption: `@${num.split("@")[0]} Bye Beban Gosah Join Lagi Buang Buang Data Aja ${metadata.subject}` })
